...
export K8SHA_IPLOCAL=192.168.122.225
...
export K8SHA_IPVIRTUAL=192.168.122.85

# master01 ip address
export K8SHA_IP1=192.168.122.225

# master02 ip address
export K8SHA_IP2=192.168.122.248

# master03 ip address
export K8SHA_IP3=192.168.122.240

# master01 hostname
export K8SHA_HOSTNAME1=k11

# master02 hostname
export K8SHA_HOSTNAME2=k12

# master03 hostname
export K8SHA_HOSTNAME3=k13
